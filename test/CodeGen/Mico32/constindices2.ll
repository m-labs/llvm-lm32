...
declare i32 @printf(i8*, double, double, double, double)
...
define i32 @main() {
        ...
        call i32 (i8*, double, double, double, double)* @printf( i8* %castFmt, double %dsqrtTwo, double %dexp, double %dpi, double %dfive )     ; <i32>:1 [#uses=0]
        ret i32 0
}
