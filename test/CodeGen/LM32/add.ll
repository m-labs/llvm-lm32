...
; DONT: grep {	subl} %t.s | count 2
; DONT: grep {	subq} %t.s | count 1
;
; DONT: grep {lda \$0,-100(\$16)} %t.s | count 1
; DONT: grep {s4addl} %t.s | count 2
; DONT: grep {s8addl} %t.s | count 2
; DONT: grep {s4addq} %t.s | count 2
; DONT: grep {s8addq} %t.s | count 2
;
; DONT: grep {s4subl} %t.s | count 2
; DONT: grep {s8subl} %t.s | count 2
; DONT: grep {s4subq} %t.s | count 2
; DONT: grep {s8subq} %t.s | count 2
