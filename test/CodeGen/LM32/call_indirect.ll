...
; DONTRUN: grep rotqby  %t1.s | count 6
; DONTRUN: grep lqa     %t1.s | count 1
; DONTRUN: grep lqd     %t1.s | count 12
; DONTRUN: grep dispatch_tab %t1.s | count 5
; DONTRUN: grep bisl    %t2.s | count 7
; DONTRUN: grep ilhu    %t2.s | count 2
; DONTRUN: grep iohl    %t2.s | count 2
; DONTRUN: grep rotqby  %t2.s | count 6
; DONTRUN: grep lqd     %t2.s | count 13
; DONTRUN: grep ilhu    %t2.s | count 2
; DONTRUN: grep ai      %t2.s | count 9
; DONTRUN: grep dispatch_tab %t2.s | count 6
