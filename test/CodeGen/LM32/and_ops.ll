; lm32 can return < 2 x i32> at most.
; XFAIL: *
...
define i32 @andi_u32(i32 zeroext  %in) {
        %tmp37 = and i32 %in, 37
        ret i32 %tmp37
}

define i32 @andi_i32(i32 signext  %in) {
        %tmp38 = and i32 %in, 37
        ret i32 %tmp38
}
...
define i16 @andhi_u16(i16 zeroext  %in) {
        %tmp37 = and i16 %in, 37         ; <i16> [#uses=1]
        ret i16 %tmp37
}

define i16 @andhi_i16(i16 signext  %in) {
...
define i8 @and_u8(i8 zeroext  %in) {
        ; ANDBI generated:
        %tmp37 = and i8 %in, 37
        ret i8 %tmp37
}

define i8 @and_sext8(i8 signext  %in) {
        ; ANDBI generated
        %tmp38 = and i8 %in, 37
        ret i8 %tmp38
}
